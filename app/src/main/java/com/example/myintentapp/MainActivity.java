    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Mehh Boy");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 3);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "082267372088";
                Intent dialPhoneIntent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:"+phoneNumber));
                startActivity(dialPhoneIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Mehh");
                mPerson.setAge(5);
                mPerson.setEmail("Affandy.affa2589@gmail.com");
                mPerson.setCity("Medan");
